...
++++
<a href="tekton-dev-1.png" target="_blank">
  <img src="tekton-dev-1.png" alt="Click to enlarge" style="max-width:300px;">
</a>
++++
// image::tekton-dev-1.png[link=ROOT/assets/images/tekton-dev-1.png[, window=_blank, title="Click to expand"]]

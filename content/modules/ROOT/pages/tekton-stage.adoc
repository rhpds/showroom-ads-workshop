...
* In the `deployment-patch.yaml` file, notice how the image tag has been automatically updated to your tag
...
* In the `Topology` tab in Developer Hub, locate the staging application `qrks-tkn-{user}-stage` and click on the 'Open URL' icon (the arrow on the top right of your application) to open the route.

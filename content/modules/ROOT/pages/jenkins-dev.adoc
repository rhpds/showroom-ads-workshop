...
* Your quarkus source code repository cloned into the environment
* In the quarkus-jnk-{user} folder
...
* **What's happening now?** You're prompted for signed commit authentication
  - The terminal shows a URL - this is an OAuth flow to verify your identity

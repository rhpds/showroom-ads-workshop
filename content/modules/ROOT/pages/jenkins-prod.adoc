...
[source,bash,subs="attributes"]
----
ec validate image --image quay.tssc-quay/tssc/qrks-jnk-{user}:v1.0 --policy default --public-key k8s://openshift/trusted-keys --output json
----
...
[source,bash,subs="attributes"]
----
skopeo copy docker://quay.tssc-quay/tssc/qrks-jnk-{user}:v1.0 docker://quay.tssc-quay/tssc/qrks-jnk-{user}:prod-v1.0
----

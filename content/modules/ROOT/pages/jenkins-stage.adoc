...
* In the `Topology` tab in Developer Hub, locate the staging application and click on the 'Open URL' icon (the arrow on the top right of your application) to open the route.
